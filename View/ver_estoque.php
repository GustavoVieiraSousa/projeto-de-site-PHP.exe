...
<html>
  ...
  <div class="bg-light px-5  container" style="height:425px ; width:70%;position: absolute; left:15%; right:15%;">
      <form class="row g-3 pt-5" method="POST" action="../Model/Selectestoque.php">
                <center> <h1>escolha o estoque</h1></center>
 
                
  <div class="col-md-4 ml-3">
    <label for="validationDefault02" class="form-label ">cod_estoque</label>
    <input type="text" class="form-control bg-dark text-white" name="cod_estoque" placeholder="id do estoque" id="validationDefault02"  required>
  </div>
                <div class="col-md-4">
    <label for="validationDefault02" class="form-label ">nome</label>
    <input type="text" class="form-control bg-dark text-white" name="nome_estoque" placeholder="nome do estoque" id="validationDefault02" required>
  </div>
                
                  <div class="col-12">
    <button class="btn btn-primary" name="logar" type="submit">procurar</button>
  </div>
                <h5>
