...
<html>
  ...
  <div class="bg-light px-5  container" style="height:425px ; width:70%;position: absolute; left:15%; right:15%;">
      <form class="row g-3 pt-5" method="POST" action="../Model/deletarPROD.php">
                <center> <h1>Deletar produto</h1></center>
  ...
  <div class="col-md-4 ml-3">
    ...
    <button class="btn btn-primary" name="logar" type="submit">cadastrar</button>
                ...
                <h5>
                    <a href="cadastro_prod.php">clique aqui para inserir algum produto</a> </h5>
</form>
            </div>
